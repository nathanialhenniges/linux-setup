...
- When an approved install route replaces an older package-manager route, verify the replacement first, then remove only the recognized old package. Preview the migration in check mode. Never delete arbitrary user files or unknown binaries.
